...
namespace BH.Engine.Spatial
{
    public static partial class Query
    {
        ...
        [Input("orthogonalLengthFactor", "Optional, tests the orthogonal vector lengths in relation to the actual non-orthogonal dominant vector. \n" + 
            "For example if the dominant vector is 10 in length but the orthogonal is only 5 in length, then this number should be 0.5 for it to pass the test.")]
